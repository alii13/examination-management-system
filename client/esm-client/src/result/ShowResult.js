...
function ShowResult(props) {
  ...
  let marks, name, rightAnswers, submitMinutes, totalMarks, wrongAnswers, totalAttempt;

  if (testInfo) {
    marks = testInfo.marks;
    name = testInfo.name;
    rightAnswers = testInfo.rightAnswers;
              ...
              <div className="result__wrapper__body">
                ...
                <div className="attempted">
                  <div className="total__attempted">
                    <div className="percentage">
                      <div className="percentage__heading">Attempted: {totalAttempt} </div>
                      <Progress
                  ...
                  <div className="percentage">
                    <div className="percentage__heading">Correct Answers: {rightAnswers}</div>
                      <Progress
