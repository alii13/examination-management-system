        ...
        <div className="student__status__wrapper">
          ...
          <div className="student__status__body">
            ...
            <div className="status__test__correct">
              Correct Answers:   <span className="status__testname success-wihtoutFont">{student.correct}</span>
            </div>
            <div className="status__test__wrong">
              Wrong Answers:    <span className="status__testname danger">{student.wrong}</span>
            </div>
            <div className="status__test__unanswered">
              Not Answered:    <span className="status__testname primary-wihtoutFont">{student.unanswered}</span>
            </div>
          </div>
        </div>
      </Col>
